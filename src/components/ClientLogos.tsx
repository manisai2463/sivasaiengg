...
export const CLIENT_LOGOS: ClientLogo[] = [
  {
    name: 'SIEMENS',
    logo: (
      <svg viewBox="0 0 120 30" className="w-24 h-7 text-gray-500 group-hover:text-[#009999] fill-current transition-colors duration-300">
  ...
  },
  {
    name: 'BHEL',
    logo: (
      <svg viewBox="0 0 100 35" className="w-20 h-7 text-gray-500 group-hover:text-blue-500 fill-current transition-colors duration-300">
  ...
  },
  {
    name: 'NPCIL',
    logo: (
      <svg viewBox="0 0 120 35" className="w-24 h-8 text-gray-500 group-hover:text-green-400 fill-current transition-colors duration-300">
  ...
  },
  {
    name: 'RELIANCE',
    logo: (
      <svg viewBox="0 0 120 30" className="w-24 h-7 text-gray-500 group-hover:text-red-500 fill-current transition-colors duration-300">
  ...
  },
  {
    name: 'JSW STEEL',
    logo: (
      <svg viewBox="0 0 120 30" className="w-24 h-7 text-gray-500 group-hover:text-cyan-400 fill-current transition-colors duration-300">
        {/* JSW Steel Emblem */}
  ...
  },
  {
    name: 'L&T',
    logo: (
      <svg viewBox="0 0 100 30" className="w-20 h-7 text-gray-500 group-hover:text-yellow-500 fill-current transition-colors duration-300">
        {/* L&T Typography */}
  ...
  },
  {
    name: 'ONGC',
    logo: (
      <svg viewBox="0 0 100 30" className="w-20 h-7 text-gray-500 group-hover:text-red-400 fill-current transition-colors duration-300">
        {/* ONGC Square symbol */}
  ...
  },
  {
    name: 'NALCO',
    logo: (
      <svg viewBox="0 0 110 30" className="w-24 h-7 text-gray-500 group-hover:text-blue-400 fill-current transition-colors duration-300">
        {/* NALCO Design */}
  ...
  },
  {
    name: 'ITC LIMITED',
    logo: (
      <svg viewBox="0 0 100 30" className="w-20 h-7 text-gray-500 group-hover:text-orange-400 fill-current transition-colors duration-300">
        {/* ITC logo */}
  ...
  },
  {
    name: 'ADITYA BIRLA',
    logo: (
      <svg viewBox="0 0 120 30" className="w-24 h-7 text-gray-500 group-hover:text-yellow-600 fill-current transition-colors duration-300">
        {/* Rising Sun */}
    ...
    <div className="w-full flex relative overflow-hidden pointer-events-none">
      ...
      <div className="flex gap-16 items-center whitespace-nowrap animate-marquee py-4 shrink-0">
        {CLIENT_LOGOS.concat(CLIENT_LOGOS).map((client, idx) => (
          <div
            key={idx}
            className="group flex items-center justify-center bg-[#111827]/30 border border-white/5 px-6 py-3.5 rounded-2xl hover:border-white/10 hover:bg-[#111827]/60 pointer-events-auto transition-all duration-300 shadow-lg backdrop-blur-sm"
          >
            {client.logo}
          </div>
        ))}
